...
import 'package:lydband/pages/album.dart';
import 'package:lydband/pages/artist.dart';
import 'package:lydband/pages/music.dart';
...
class _HomeState extends State<Home> {
  ...
  Container musicasBody() {
    return Container(
      ...
      child: ListView.separated(
          itemCount: musicasModels.length,
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Image.asset(musicasModels[index].pathImagem),
                    ),
                  ),
                  Text(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Container(
                        child: SvgPicture.asset("assets/icons/Estrelas.svg"),
                      ),
                      SizedBox(
                        width: 5,
                      ),
  ...
  Column _albunsRecomendados(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        albunsTitulo(),
